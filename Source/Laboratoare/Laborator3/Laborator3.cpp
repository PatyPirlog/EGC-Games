...
{    
	...
	// se misca dintr-o parte in alta 
	translateY = 0;
	if (dir == false) {
	...
	//--BONUS--
	modelMatrix *= Transform2D::Translate(700, 300); //punctul in jurul caruia ma rotesc
	modelMatrix *= Transform2D::Rotate(angularStep); //ma rotesc
	modelMatrix *= Transform2D::Translate(-500, -300); //ma duc inapoi
																								//punct mare in jurul caruia ma rotesc
	modelMatrix *= Transform2D::Translate(50, 50);  //punctul unde vreau sa ma rotesc 
	modelMatrix *= Transform2D::Rotate(angularStep); //ma rotesc
	modelMatrix *= Transform2D::Translate(-50, -50); //il duc inapoi de unde l-am luat

	modelMatrix *= Transform2D::Rotate(angularStep); //ma rotesc
	modelMatrix *= Transform2D::Translate(-300, -150); //il duc inapoi de unde l am luat
